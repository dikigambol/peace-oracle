...
ROASTING_DATA = {
    "aries": {
        "sign_name": "Aries (♈)",
        "headline": "Gak sabaran, gampang tersulut emosi, dan ngerasa seluruh dunia ini arena balapan pacuan kuda.",
        "toxic_traits": [
    ...
    "taurus": {
        "sign_name": "Taurus (♉)",
        "headline": "Keras kepala bagaikan tembok semen, hobi tidur 12 jam, dan rela putus hubungan asal gak usah bagi makanan.",
        "toxic_traits": [
    ...
    "gemini": {
        "sign_name": "Gemini (♊)",
        "headline": "Punya 4 kepribadian berbeda dalam sehari, ahli ghosting bersertifikat, dan buka 75 tab browser tanpa dibaca.",
        "toxic_traits": [
    ...
    "cancer": {
        "sign_name": "Cancer (♋)",
        "headline": "Raja/Ratu drama galau, emosional bagaikan roller coaster, dan menyimpan screenshot chat tahun 2018.",
        "toxic_traits": [
    ...
    "leo": {
        "sign_name": "Leo (♌)",
        "headline": "Narsis tingkat dewa, butuh tepuk tangan tiap 10 menit sekali, dan merasa seluruh ruangan adalah panggung miliknya.",
        "toxic_traits": [
    ...
    "virgo": {
        "sign_name": "Virgo (♍)",
        "headline": "Perfeksionis stres, suka ngatur hidup orang lain padahal hidup sendiri berantakan, dan cemas gara-gara typo.",
        "toxic_traits": [
    ...
    "libra": {
        "sign_name": "Libra (♎)",
        "headline": "Indecisive kronis, butuh waktu 45 menit cuma buat milih rasa boba, dan takut konflik sampai memendam rasa benci.",
        "toxic_traits": [
    ...
    "scorpio": {
        "sign_name": "Scorpio (♏)",
        "headline": "Detektor kebohongan berjalan, curigaan tingkat akut, dan menyusun rencana pembalasan dendam sampai detail.",
        "toxic_traits": [
    ...
    "sagittarius": {
        ...
        "headline": "Anti-komitmen, omongan ceplas-ceplos tanpa saringan emosi, dan mendadak ngilang buat mbolang.",
        "toxic_traits": [
    ...
    "capricorn": {
        "sign_name": "Capricorn (♑)",
        "headline": "Pekerja keras tanpa jiwa, mengukur kebahagiaan dari saldo tabungan, dan selalu tampak seperti bapak-bapak/ibu-ibu.",
        "toxic_traits": [
    ...
    "aquarius": {
        "sign_name": "Aquarius (♒)",
        "headline": "Merasa paling beda dari manusia bumi, emosi sedingin kulkas, dan mendadak hilang dari peradaban.",
        "toxic_traits": [
    ...
    "pisces": {
        "sign_name": "Pisces (♓)",
        "headline": "Raja/Ratu halusinasi, korban sinetron drakor, dan gampang jatuh cinta cuma gara-gara dipinjemin pulpen.",
        "toxic_traits": [
