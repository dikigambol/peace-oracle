document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupPicker(pickerId, callback) {
        ...
        picker.querySelectorAll('.shio-pick').forEach(el => {
            el.addEventListener('click', () => {
                picker.querySelectorAll('.shio-pick').forEach(p => p.classList.remove('selected'));
    ...
    setupPicker('picker-1', (key) => { shio1 = key; });
    setupPicker('picker-2', (key) => { shio2 = key; });
    ...
    function fetchCompatibility(s1, s2) {
        ...
        .then(data => {
            ...
            // Relationship type
            document.getElementById('c-relationship').textContent = data.relationship || 'Data belum tersedia';
