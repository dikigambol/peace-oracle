document.addEventListener('DOMContentLoaded', () => {
    ...
    function fetchFortune(shioKey) {
        ...
        .then(data => {
            ...
            document.getElementById('res-guardian-icon').src = staticBaseUrl + data.guardian_icon;
            document.getElementById('res-guardian-desc').textContent = data.guardian_desc;
            document.getElementById('res-mantra').textContent = data.mantra;
            document.getElementById('res-mantra-meaning').textContent = data.mantra_meaning;
            document.getElementById('res-guardian-element').textContent = data.guardian_element;
            
            document.getElementById('res-protection').textContent = data.protection_advice;
            document.getElementById('res-offering').textContent = data.offering_suggestion;
            ...
            document.getElementById('res-pray-time').textContent = data.best_pray_time;
            document.getElementById('res-sacred-dir').textContent = data.sacred_direction;
